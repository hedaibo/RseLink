...
public class Config {
    ...
    public static class PortGlob {
        ...
        public static final int MULTIPORT_IPV6 = 19696;
    ...
    public static class HandlerGlod {
        ...
        public static final int IS_LOOP_SENDBROADCAST_DELAY = 200;
        public static final int IS_LOOP_SENDBROADCAST_DELAY_LONG = 3000;
        ...
        public static final int HOSTPOT_INITNET = 0X000011;
        public static final int HOSTPOT_INITNET_DELAY = 3000;
        public static final int TIME_OUT_READ = 0X00012;
        public static final int HAS_READ_DATA = 0X00013;
        public static final int RECONNECT_SOCKET = 0X00014;
        public static final int RECONNECT_SOCKET_DELAY = 3000;
    }
    ...
    public static class ActionKey {
        ...
        public static final String SHOW_SPLASH_KEY = "showsplash:";
        public static final String SHOW_SPLASH_HIDE = "hide";
        public static final String SHOW_SPLASH_SHOW = "show";
        public static final String SERVICE_START_KEY = "start:";
        public static final String SECOND_IP = "secondip:";
